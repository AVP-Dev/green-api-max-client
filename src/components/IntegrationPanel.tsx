...
maxIframe.postMessage({ type: 'MAX_SYNC_CONTACTS', payload: {} }, MAX_WIDGET_ORIGIN);`;
  ...
  return (
    <div className="space-y-4">
      {/* Intro Header */}
      <div className="p-4 rounded-2xl bg-gradient-to-r from-indigo-50/80 to-purple-50/80 dark:from-indigo-950/40 dark:to-purple-950/30 border border-indigo-100/80 dark:border-indigo-800 flex items-start gap-3">
        <div className="w-9 h-9 rounded-xl bg-white dark:bg-slate-800 shadow-2xs text-[#471AFF] dark:text-indigo-300 flex items-center justify-center shrink-0">
      ...
      {/* Sub-Tabs */}
      <div className="flex border-b border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-800/60 rounded-xl p-1 gap-1 shrink-0 overflow-x-auto">
        <button
          type="button"
          onClick={() => setActiveTab('iframe')}
            className={`px-3 py-1.5 text-xs font-semibold rounded-lg transition-all cursor-pointer whitespace-nowrap ${
              activeTab === 'iframe'
                ? 'bg-white dark:bg-slate-700 text-[#471AFF] dark:text-indigo-200 shadow-xs'
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                readOnly
                value={embedUrl}
                className="w-full px-3 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-mono text-slate-700 dark:text-slate-200 select-all"
              />
            </div>
          </div>
        )}
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-mono text-[11px] font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-800">
...
{`{
  ...
  "message": "Привет от MAX!"
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-mono text-[11px] font-bold text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-950/60 px-2 py-0.5 rounded border border-indigo-200 dark:border-indigo-800">
