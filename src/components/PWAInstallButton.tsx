...
export const PWAInstallButton: React.FC<PWAInstallButtonProps> = ({
  ...
  if (variant === 'card') {
    return (
      <>
        <div className="p-4 rounded-2xl bg-gradient-to-br from-indigo-50/80 via-white to-purple-50/50 dark:from-indigo-950/40 dark:via-slate-900 dark:to-purple-950/30 border border-indigo-100 dark:border-indigo-800 shadow-xs">
        ...
        {showIOSGuide && (
          ...
          >
            <div
              className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 p-5 shadow-2xl border border-slate-200 dark:border-slate-700 animate-in zoom-in-95 duration-200"
            ...
            >
              ...
              <div className="py-4 space-y-3.5 text-xs text-slate-600 dark:text-slate-300">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-indigo-50 dark:bg-indigo-950/60 text-[#471AFF] dark:text-indigo-300 font-bold flex items-center justify-center shrink-0 text-xs">
                    1
                  </div>
  ...
  return (
    <>
      ...
      {showIOSGuide && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 p-5 shadow-2xl border border-slate-200 dark:border-slate-700"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
